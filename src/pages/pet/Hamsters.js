...
export default function Hamsters() {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch("https://petsconnectapi.onrender.com/hamsters");
    ...
    return (
        <div>
        <Navbar/>
          <div className="header"> Hamsters</div>
            ...
            <div className='addicon'>
                <Link className='link' to="/hamstersadform"><IoMdAddCircleOutline className='icon' /></Link> 
                <div>
                    Sell
                </div>
            </div>

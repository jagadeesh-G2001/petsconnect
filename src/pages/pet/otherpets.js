...
export default function Otherpets() {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch("https://petsconnectapi.onrender.com/others");
    ...
    return (
        <div>
        <Navbar/>
          <div className="header"> Otherpets</div>
            ...
            <div className='addicon'>
                <Link className='link' to="/otherpetsadform"><IoMdAddCircleOutline className='icon' /></Link> 
                <div>
                    Sell
                </div>
            </div>
